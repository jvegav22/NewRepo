    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (codigo.Equals("1"))
            {
                ...
                Console.WriteLine("Precio de la hora es de : " + horaprecio);
                Console.WriteLine("El monto a pagar por horas trabajadas: " + canthoras);
                Console.WriteLine("Cantidad de horas :" + hora);
                Console.WriteLine("La deduccion a su salario por la CCSS es de 9.17% el monto es :" + dedccss);
